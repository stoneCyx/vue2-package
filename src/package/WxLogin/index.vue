...
export default {
  ...
  computed: {
    setSrc() {
      const url = 'https://open.weixin.qq.com/connect/qrconnect?appid=wx4a81494979a58162&redirect_uri=http%3A%2F%2Fwww.a.zgbook.top%2F&response_type=code&scope=snsapi_login&state=3d6be0a4035d839573b04816624a415e#wechat_redirect';
      return url;
    },
  },
  props: {
